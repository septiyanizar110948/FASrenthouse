...
<!-- Meta Tags -->
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<link href="images/123.png" rel="icon">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Selling properties is easier and faster with the best features and services from Fas Renthouse</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Get affordable housing and find out the cost of repaying a house or other property through a mortgage simulation at Fas Renthouse</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Fas renthouse is the largest and most trusted property site that has served millions of Indonesians</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>FAS Renthouse as a trusted property site is ready to help find your dream residence.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our company sells and rents various types of properties with guaranteed quality with the safety of buyers / tenants who will keep our properties and prices that are affordable for buyers and our company sells various properties throughout Indonesia</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We provide the best quality property and are done by experts.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Employee Quality</h5>
										<p>With the best and professional workforce, we are ready to provide the best service for you.</p>
									</div>
                                </li>
                            </ul>
                        </div>
